...
from . import views
from .views import home_view,book_appointment_view,available_doctors_view,doctor_availability_view,successfully_booked_appointment_view,patient_medical_history_view
